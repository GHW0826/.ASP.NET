...
using SwaggerJWTAuthorize.Middlewares;
using SwaggerJWTAuthorize.Validators;
...
/*
    Swagger UI 오른쪽 상단에 Authorize 버튼 추가
    JWT 토큰을 Authorization: Bearer {token} 형태로 자동 전송
    [Authorize], [Authorize(Roles="Admin")] API를 Swagger에서 바로 호출 가능
