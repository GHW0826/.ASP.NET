...
namespace Dockerfiles.Controllers
{
    [ApiController]
    [ApiVersion("1.0")]
    [ApiVersion("3.0")]
    ...
    public class TodoController : ControllerBase
    {
        ...
        public TodoController(ILogger<TodoController> logger, IMapper mapper, AppDbContext context, ITodoService todoService)
        {
        ...
        public async Task<ActionResult<IEnumerable<GetTodoDto>>> GetAllV1()
        {
            ...
            return Ok(ApiResponse<List<GetTodoDto>>.Ok(result));
        }
