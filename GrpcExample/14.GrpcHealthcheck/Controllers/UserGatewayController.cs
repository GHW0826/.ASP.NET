...
namespace GrpcHealthcheck.Controllers;

[ApiController]
[Route("api/gateway/[controller]")]
public class UserGatewayController : ControllerBase
{
    private readonly GrpcHealthcheck.Services.UserService _userService;

    public UserGatewayController(GrpcHealthcheck.Services.UserService userService)
    {
