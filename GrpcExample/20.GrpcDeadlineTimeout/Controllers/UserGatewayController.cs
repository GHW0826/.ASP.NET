...
namespace GrpcDeadlineTimeout.Controllers;

[ApiController]
[Route("api/gateway/[controller]")]
public class UserGatewayController : ControllerBase
{
    private readonly GrpcDeadlineTimeout.Services.UserService _userService;

    public UserGatewayController(GrpcDeadlineTimeout.Services.UserService userService)
    {
