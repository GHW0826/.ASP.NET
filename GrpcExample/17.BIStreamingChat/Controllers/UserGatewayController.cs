...
namespace BIStreamingChat.Controllers;

[ApiController]
[Route("api/gateway/[controller]")]
public class UserGatewayController : ControllerBase
{
    private readonly BIStreamingChat.Services.UserService _userService;

    public UserGatewayController(BIStreamingChat.Services.UserService userService)
    {
