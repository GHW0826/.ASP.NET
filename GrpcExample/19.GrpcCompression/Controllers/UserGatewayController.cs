...
namespace GrpcCompression.Controllers;

[ApiController]
[Route("api/gateway/[controller]")]
public class UserGatewayController : ControllerBase
{
    private readonly GrpcCompression.Services.UserService _userService;

    public UserGatewayController(GrpcCompression.Services.UserService userService)
    {
